...
?>
    ...
    <div style="margin-top: 30px; margin-bottom: 10px; padding: 5px; padding-left: 15px; border: 1px solid #ccc; position: relative">
      ...
      <div class="googleAd">
          <?php include_partial('adv/googleAdsenseLeaderboardSettings') ?>
      </div>
    </div>
