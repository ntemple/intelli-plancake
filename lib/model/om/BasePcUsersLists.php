...
/**
 * Base class that represents a row from the 'pc_users_lists' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BasePcUsersLists extends BaseObject  implements Persistent {
	 ...
	 * @return     PcUsersLists The current object (for fluent API support)
	 */
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = PcUsersListsPeer::USER_ID;
		}
	...
	public function setListId($v)
	{
		...
		if ($this->list_id !== $v) {
			$this->list_id = $v;
			$this->modifiedColumns[] = PcUsersListsPeer::LIST_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = PcUsersListsPeer::NUM_COLUMNS - PcUsersListsPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PcUsersLists object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PcUsersListsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BasePcUsersLists:delete:pre') as $callable)
			{
			...
			if ($ret) {
				PcUsersListsPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePcUsersLists:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasePcUsersLists:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePcUsersLists:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				PcUsersListsPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PcUsersListsPeer::doInsert($this, $con);
					...
					$affectedRows += PcUsersListsPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PcUsersListsPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PcUsersListsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PcUsersListsPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PcUsersListsPeer::USER_ID)) $criteria->add(PcUsersListsPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(PcUsersListsPeer::LIST_ID)) $criteria->add(PcUsersListsPeer::LIST_ID, $this->list_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PcUsersListsPeer::USER_ID, $this->user_id);
		$criteria->add(PcUsersListsPeer::LIST_ID, $this->list_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PcUsersLists (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PcUsersLists Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PcUsersListsPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PcUsersListsPeer();
		}
		return self::$peer;
	}
	...
	public function getPcUser(PropelPDO $con = null)
	{
		if ($this->aPcUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPcUser->addPcUsersListss($this);
			 */
		}
		return $this->aPcUser;
	}
	...
	public function getPcList(PropelPDO $con = null)
	{
		if ($this->aPcList === null && ($this->list_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPcList->addPcUsersListss($this);
			 */
		}
		return $this->aPcList;
	}
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePcUsersLists:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePcUsersLists::%s', $method));
	  }
