...
/**
 * Base class that represents a row from the 'pc_users_contexts' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BasePcUsersContexts extends BaseObject  implements Persistent {
	...
	const PEER = 'PcUsersContextsPeer';
	...
	/**
	 * Initializes internal state of BasePcUsersContexts object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PcUsersContexts The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PcUsersContextsPeer::ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = PcUsersContextsPeer::USER_ID;
		}
	...
	public function setContext($v)
	{
		...
		if ($this->context !== $v) {
			$this->context = $v;
			$this->modifiedColumns[] = PcUsersContextsPeer::CONTEXT;
		}
	...
	public function setSortOrder($v)
	{
		...
		if ($this->sort_order !== $v || $this->isNew()) {
			$this->sort_order = $v;
			$this->modifiedColumns[] = PcUsersContextsPeer::SORT_ORDER;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PcUsersContextsPeer::UPDATED_AT;
			}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PcUsersContextsPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = PcUsersContextsPeer::NUM_COLUMNS - PcUsersContextsPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PcUsersContexts object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PcUsersContextsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BasePcUsersContexts:delete:pre') as $callable)
			{
			...
			if ($ret) {
				PcUsersContextsPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePcUsersContexts:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasePcUsersContexts:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(PcUsersContextsPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(PcUsersContextsPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePcUsersContexts:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				PcUsersContextsPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PcUsersContextsPeer::doInsert($this, $con);
					...
					$affectedRows += PcUsersContextsPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PcUsersContextsPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PcUsersContextsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PcUsersContextsPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PcUsersContextsPeer::ID)) $criteria->add(PcUsersContextsPeer::ID, $this->id);
		if ($this->isColumnModified(PcUsersContextsPeer::USER_ID)) $criteria->add(PcUsersContextsPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(PcUsersContextsPeer::CONTEXT)) $criteria->add(PcUsersContextsPeer::CONTEXT, $this->context);
		if ($this->isColumnModified(PcUsersContextsPeer::SORT_ORDER)) $criteria->add(PcUsersContextsPeer::SORT_ORDER, $this->sort_order);
		if ($this->isColumnModified(PcUsersContextsPeer::UPDATED_AT)) $criteria->add(PcUsersContextsPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(PcUsersContextsPeer::CREATED_AT)) $criteria->add(PcUsersContextsPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PcUsersContextsPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PcUsersContexts (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PcUsersContexts Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PcUsersContextsPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PcUsersContextsPeer();
		}
		return self::$peer;
	}
	...
	public function getPcUser(PropelPDO $con = null)
	{
		if ($this->aPcUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPcUser->addPcUsersContextss($this);
			 */
		}
		return $this->aPcUser;
	}
	 ...
	 * Otherwise if this PcUsersContexts has previously been saved, it will retrieve
	 * related PcTasksContextss from storage. If this PcUsersContexts is new, it will return
		...
		if ($this->collPcTasksContextss === null) {
			if ($this->isNew()) {
			   $this->collPcTasksContextss = array();
				...
				$criteria->add(PcTasksContextsPeer::USERS_CONTEXTS_ID, $this->id);
	 ...
	 * Otherwise if this PcUsersContexts is new, it will return
	 * an empty collection; or if this PcUsersContexts has previously
	 * been saved, it will retrieve related PcTasksContextss from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in PcUsersContexts.
	 */
	public function getPcTasksContextssJoinPcTask($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PcUsersContextsPeer::DATABASE_NAME);
		}
		...
		if ($this->collPcTasksContextss === null) {
			if ($this->isNew()) {
				...
				$this->collPcTasksContextss = PcTasksContextsPeer::doSelectJoinPcTask($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePcUsersContexts:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePcUsersContexts::%s', $method));
	  }
