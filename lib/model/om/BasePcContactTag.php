...
/**
 * Base class that represents a row from the 'pc_contact_tag' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BasePcContactTag extends BaseObject  implements Persistent {
	 ...
	 * @return     PcContactTag The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PcContactTagPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = PcContactTagPeer::NAME;
		}
	...
	public function setCreatorId($v)
	{
		...
		if ($this->creator_id !== $v) {
			$this->creator_id = $v;
			$this->modifiedColumns[] = PcContactTagPeer::CREATOR_ID;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PcContactTagPeer::UPDATED_AT;
			}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PcContactTagPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = PcContactTagPeer::NUM_COLUMNS - PcContactTagPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PcContactTag object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PcContactTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(PcContactTagPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		try {
			...
			foreach (sfMixer::getCallables('BasePcContactTag:delete:pre') as $callable)
			{
			...
			if ($ret) {
				PcContactTagPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePcContactTag:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasePcContactTag:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(PcContactTagPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(PcContactTagPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePcContactTag:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				PcContactTagPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PcContactTagPeer::doInsert($this, $con);
					...
					$affectedRows += PcContactTagPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PcContactTagPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PcContactTagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PcContactTagPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PcContactTagPeer::ID)) $criteria->add(PcContactTagPeer::ID, $this->id);
		if ($this->isColumnModified(PcContactTagPeer::NAME)) $criteria->add(PcContactTagPeer::NAME, $this->name);
		if ($this->isColumnModified(PcContactTagPeer::CREATOR_ID)) $criteria->add(PcContactTagPeer::CREATOR_ID, $this->creator_id);
		if ($this->isColumnModified(PcContactTagPeer::UPDATED_AT)) $criteria->add(PcContactTagPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(PcContactTagPeer::CREATED_AT)) $criteria->add(PcContactTagPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PcContactTagPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PcContactTag (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PcContactTag Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PcContactTagPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PcContactTagPeer();
		}
		return self::$peer;
	}
	...
	public function getPcUser(PropelPDO $con = null)
	{
		if ($this->aPcUser === null && ($this->creator_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPcUser->addPcContactTags($this);
			 */
		}
		return $this->aPcUser;
	}
	 ...
	 * Otherwise if this PcContactTag has previously been saved, it will retrieve
	 * related PcContactsTagss from storage. If this PcContactTag is new, it will return
		...
		if ($this->collPcContactsTagss === null) {
			if ($this->isNew()) {
			   $this->collPcContactsTagss = array();
				...
				$criteria->add(PcContactsTagsPeer::TAG_ID, $this->id);
	 ...
	 * Otherwise if this PcContactTag is new, it will return
	 * an empty collection; or if this PcContactTag has previously
	 * been saved, it will retrieve related PcContactsTagss from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in PcContactTag.
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePcContactTag:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePcContactTag::%s', $method));
	  }
