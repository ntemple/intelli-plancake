...
/**
 * This class defines the structure of the 'pc_blog_comment' table.
 *
 *
 *
 ...
 */
class PcBlogCommentTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PcBlogCommentTableMap';
	...
	{
	  // attributes
		$this->setName('pc_blog_comment');
		$this->setPhpName('PcBlogComment');
		$this->setClassname('PcBlogComment');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
		$this->addForeignKey('POST_ID', 'PostId', 'INTEGER', 'pc_blog_post', 'ID', true, null, null);
