...
/**
 * This class defines the structure of the 'pc_note' table.
 *
 *
 *
 ...
 */
class PcNoteTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PcNoteTableMap';
	...
	{
	  // attributes
		$this->setName('pc_note');
		$this->setPhpName('PcNote');
		$this->setClassname('PcNote');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
		$this->addForeignKey('CREATOR_ID', 'CreatorId', 'INTEGER', 'pc_user', 'ID', true, null, null);
		$this->addColumn('TITLE', 'Title', 'VARCHAR', true, 127, null);
