...
/**
 * This class defines the structure of the 'pc_archived_task' table.
 *
 *
 *
 ...
 */
class PcArchivedTaskTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PcArchivedTaskTableMap';
	...
	{
	  // attributes
		$this->setName('pc_archived_task');
		$this->setPhpName('PcArchivedTask');
		$this->setClassname('PcArchivedTask');
