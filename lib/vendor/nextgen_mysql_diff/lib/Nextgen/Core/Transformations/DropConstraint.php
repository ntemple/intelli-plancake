...
class Nextgen_Core_Transformations_DropConstraint extends Nextgen_Core_Transformation
{
    /*
    ...
    {
        return "ALTER TABLE `{$this->tableName}` DROP CONSTRAINT `{$this->constraintName}`;";
    }
}