...
class Nextgen_Core_Transformations_AddPrimaryKey extends Nextgen_Core_Transformation
{
    /*
    ...
    {
      $this->mandatoryParams = array('tableName');
    ...
    {
        $primaryKeyContent = self::$db2->getTable($this->tableName)->getPrimaryKey()->getValue();
        return "ALTER TABLE `{$this->tableName}` ADD PRIMARY KEY ($primaryKeyContent);";
    }
}