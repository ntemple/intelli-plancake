...
class Nextgen_Core_Transformations_AlterFieldPosition extends Nextgen_Core_Transformation
{
    /*
    ...
    public function getSql()
    {
        ...
        $fieldContent = self::$db2->getTable($this->tableName)->getField($this->fieldName)->getContent();
        return "ALTER TABLE `{$this->tableName}` MODIFY `{$this->fieldName}` $fieldContent $afterStatement;";
    }
}