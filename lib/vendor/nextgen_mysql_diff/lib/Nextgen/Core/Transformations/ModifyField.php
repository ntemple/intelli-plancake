...
class Nextgen_Core_Transformations_ModifyField extends Nextgen_Core_Transformation
{
    /*
    ...
    public function getSql()
    {
        ...
        return "ALTER TABLE `{$this->tableName}` MODIFY `{$this->fieldName}` $fieldContent;";
    }
}